...
1. Khi User thể hiện ý định (intent), hành vi (behavior), sở thích, phong cách (style), hoặc định dạng yêu thích (format), BẮT BUỘC GỌI update_memory để ghi nhớ TRƯỚC KHI phản hồi.
...
Ví dụ tín hiệu cần update_memory:
